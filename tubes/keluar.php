...
$stockkeluar = mysqli_query($conn, "SELECT * FROM keluar k, stock s WHERE s.id_barang = k.id_barang");
   ...
   <div class="row">
     <div class="col-md">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
           <i class="bi bi-person-plus-fill"></i>&nbsp;Keluarkan Stock Gadget
        </button>
     </div>
   </div>
   <div class="row my-5">
     <div class="col-md">
        <table id="example" class="table table-striped" style="width:100%">
            ...
            <tbody>
            <?php foreach($stockkeluar as $row) :?>
                <tr>
                    <td><?= $row['tanggal'];?></td>
              ...
              <form action="" method="POST" autocomplete="off">
                        ...
                        <br>
                           <div class="modal-footer">
                              <button type="submit" name="barangkeluar" class="btn btn" style="background-color:#E3BEC6 ;">Submit</button> 
                           </div>
                 </form>
              </div> 
          </div>
